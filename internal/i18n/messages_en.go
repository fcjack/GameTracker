...
var enMessages = map[string]string{
	...
	"error.epic_not_linked":            "Epic Games account not linked",
	"error.clear_epic_library_failed":  "Failed to clear Epic library",
	"error.unlink_epic_failed":         "Failed to unlink Epic Games account",
	...
	"profile.clear_epic_library":           "Clear Epic games",
	"profile.clear_epic_library_hint":      "Remove all Epic-imported games from your local library so you can sync again from scratch.",
	"profile.clear_epic_library_confirm":   "Remove all Epic games from your local library? This cannot be undone, but you can sync again afterward.",
	"profile.epic_library_cleared":         "Removed %d Epic game from your library.",
	"profile.epic_library_cleared_plural":  "Removed %d Epic games from your library.",
	"profile.unlink_epic_confirm":          "Unlink your Epic Games account? Imported Epic games will be removed from your library and you can link a different account afterward.",
	"profile.epic_unlinked":                "Epic Games account unlinked.",

	"import.importing":                   "Importing Steam library…",
	"import.importing_xbox":              "Importing Xbox library…",
	"import.importing_epic":              "Importing Epic library…",
	...
	"import.processed_games_epic":        "Processed %d game from Epic.",
	"import.processed_games_epic_plural": "Processed %d games from Epic.",
	"import.no_games_found":              "No games found in your Steam library.",
	"import.no_games_found_xbox":         "No games found in your Xbox library.",
	"import.no_games_found_epic":         "No games found in your Epic library.",
	...
	"import.imported_epic":               "Imported %d game from Epic",
	"import.imported_epic_plural":        "Imported %d games from Epic",
